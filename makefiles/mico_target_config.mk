...
$(CONFIG_FILE): $(MiCO_SDK_MAKEFILES) | $(CONFIG_FILE_DIR)
	...
	$(QUIET)$(call WRITE_FILE_APPEND, $(CONFIG_FILE) ,BK3266_RAW_FILE 				:= $(BK3266_RAW_FILE))
	$(QUIET)$(call WRITE_FILE_APPEND, $(CONFIG_FILE) ,GOLDENMAP_FILE 				:= $(GOLDENMAP_FILE))
	$(QUIET)$(call WRITE_FILE_APPEND, $(CONFIG_FILE) ,VBS_FLASH_SONG_SRC_DIR 			:= $(VBS_FLASH_SONG_SRC_DIR))
	$(QUIET)$(call WRITE_FILE_APPEND, $(CONFIG_FILE) ,VBS_FLASH_SOUND_REMIND_SRC_DIR 	:= $(VBS_FLASH_SOUND_REMIND_SRC_DIR))
	$(QUIET)$(call WRITE_FILE_APPEND, $(CONFIG_FILE) ,BK3266CRC_FILE 					:= $(BK3266CRC_FILE))
	$(QUIET)$(call WRITE_FILE_APPEND, $(CONFIG_FILE) ,BK3266_OTA_HDR_SCRIPT_FILE 		:= $(BK3266_OTA_HDR_SCRIPT_FILE))