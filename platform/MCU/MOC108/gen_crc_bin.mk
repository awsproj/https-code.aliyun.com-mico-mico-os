...
BK3266_OTA_FILE := lib_audio_3266/firmware/1.6/BK326x_s_flash_image_crc_10151427.bin
...
BK3266_OTA_HDR_FILE := build/$(CLEANED_BUILD_STRING)/resources/$(BK3266_OTA_FILE_NAME:.bin=.otahdr.bin)
...
$(BK3266_OTA_FILE): build_done

$(BK3266_OTA_XZ_FILE): $(BK3266_OTA_FILE)
	$(QUIET)$(ECHO) Compressing $< ...
	$(XZ) --lzma2=dict=32KiB --check=crc32 -k $<
	$(MV) $(<:.bin=.bin.xz) $(BK3266_OTA_XZ_FILE)
...
$(MICO_ALL_BIN_OUTPUT_FILE): $(OTA_BIN_OUTPUT_FILE) $(BK3266_OTA_HDR_FILE) sflash_gen_filesystem
	$(QUIET)$(ECHO) Making $@ ...
