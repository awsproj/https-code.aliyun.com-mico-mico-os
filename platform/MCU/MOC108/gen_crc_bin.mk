...
BK3266_RAW_FILE := lib_audio_3266/firmware/2.3/BK326x_s_flash_image_crc.bin
...
$(BK3266_OTA_HDR_FILE): $(BK3266_RAW_XZ_FILE)
	...
	$(eval CRCVAL := $(shell $(BK3266CRC) -f $(BK3266_RAW_XZ_FILE) -l $(SIZEVAL)))
	$(eval SIZEVAL := $(shell $(PYTHON) $(IMAGE_SIZE_SCRIPT) $(BK3266_RAW_XZ_FILE)))
...
$(MICO_ALL_BIN_OUTPUT_FILE): $(OTA_BIN_OUTPUT_FILE) $(BK3266_OTA_HDR_FILE) $(BK3266_OTA_FILE) sflash_gen_filesystem
	$(QUIET)$(ECHO) Making $@ ...
