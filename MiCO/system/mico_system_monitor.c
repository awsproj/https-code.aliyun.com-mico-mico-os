...
#define APPLICATION_WATCHDOG_TIMEOUT_SECONDS  25 /**< Monitor point defined by mico system 25 seconds to reload. */
#else
#define APPLICATION_WATCHDOG_TIMEOUT_SECONDS  5 /**< Monitor point defined by mico system 5 seconds to reload. */
#endif                                     
